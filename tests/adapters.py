...
def run_swiglu(
    ...
    test_model = SwiGLU(d_model, d_ff)
    test_model.w1.weights = nn.Parameter(w1_weight)
    test_model.w2.weights = nn.Parameter(w2_weight)
    test_model.w3.weights = nn.Parameter(w3_weight)
    return test_model(in_features)
    raise NotImplementedError
...
def run_multihead_self_attention(
    ...
    multi.O.weights = nn.Parameter(o_proj_weight)
...
def run_multihead_self_attention_with_rope(
    ...
    multi.V.weights = nn.Parameter(v_proj_weight)
    multi.O.weights = nn.Parameter(o_proj_weight)
    return multi(in_features, token_positions)
    raise NotImplementedError
...
def get_tokenizer(
    ...
    """
    tker = Tokenizer(vocab, merges, special_tokens)
    return tker
    raise NotImplementedError
